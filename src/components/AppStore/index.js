        ...
        return(
            <div className="bg-container">
                ...
                <div className="input-container">
                  <input type="search" placeholder="Search" className="input-box"  onChange={this.searchApp}/>
                  <img src="https://assets.ccbp.in/frontend/react-js/app-store/app-store-search-img.png" alt="delete-icon" className="search-icon"/>
                </div>
                <ul className="tabs-container">
                    {tabsList.map(eachItem=><TabItem details={eachItem} key={eachItem.tabId} getTabId={this.getTabId} isActive={activeTabId===eachItem.tabId} />)}
                </ul>
                <ul className="apps-container">
                    {filteredApps.map(eachItem=><AppItem details={eachItem} key={eachItem.appId}/>)}
                </ul>
